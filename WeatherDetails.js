...
export default function WeatherDetails({currentWeather, unitsSystem}) {
    ...
    var windSpeedInKnots = Math.round(speed*1.9438)
    var upper = parseInt(temp_max) 
    var lower = parseInt(temp_min)
                ...
                <View style={{ ...styles.weatherDetailsBox, borderRightWidth: 1, borderRightColor: BORDER_COLOR }}>
                    <View style={styles.weatherDetailsRow}>
                        ...
                        <View style={styles.weatherDetailsItems}>
                            ...
                            {(() => {
                                if (feels_like<0){
                                    return <Text>Warnning: Potential Ice</Text>
                                }else if(feels_like>17){
                                    return <Text>Drink plenty of water</Text>
                                }
                            })()}
                        </View>
                    </View>
                ...
                <View style={{ ...styles.weatherDetailsBox, borderRightWidth: 1, borderRightColor: BORDER_COLOR }}>
                    <View style={styles.weatherDetailsRow}>
                        ...
                        <View style={styles.weatherDetailsItems}>
                            ...
                            {(() => {
                                if (temp_min<0){
                                    return <Text>Wear Extra Layers</Text>
                                }
                            })()}
                        </View>
                    </View>
                ...
                <View style={styles.weatherDetailsBox}>
                    <View style={styles.weatherDetailsRow}>
                        ...
                        <View style={styles.weatherDetailsItems}>
                            ...
                            <Text >Temprature range: {range} °</Text>
                        </View>
                    </View>
                </View>
            </View>
